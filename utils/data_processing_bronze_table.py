...
def process_bronze_table_feature(snapshot_date_str, bronze_feature_directory, spark):
    # prepare arguments
    snapshot_date = datetime.strptime(snapshot_date_str, "%Y-%m-%d")
...
def process_bronze_table_financial(snapshot_date_str, bronze_financial_directory, spark):
    # prepare arguments
    snapshot_date = datetime.strptime(snapshot_date_str, "%Y-%m-%d")
